    ...
    Node *copyList(Node *head)
       {
        ...
        while(temp!=NULL)   //We create the clone list
        ...
        // step 2 cloneNode add btwn original list
...

        {
            ...
            Node* nextNode = orignalNode->next;   

            orignalNode->next = cloneNode;

            orignalNode = nextNode;
        ...
        //Now we araange the random pointer.

        //Modify the orignal linked list with merge the clone list.
        ...
        //Reverte the changes by demodify the list into orignal list.
